...
import 'UserFields2.dart';


class SheetsFlutter2{
  ...
  static Future init() async {
    try{
      ...
      _usersheet2 =await _getWorkSheet(spreadsheet, title: "hall");
  ...
  static Future<User2?> getByUser(String empno) async{
    if(_usersheet2==null) return null;

    final json= await  _usersheet2!.values.map.rowByKey(empno,fromColumn: 1);
